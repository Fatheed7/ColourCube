...
def check_values(h, w, r, g, b):
    switch = {
        ...
        not isinstance(r, int) or not isinstance(g, int) or not isinstance(b, int): "Please enter valid integers for the red, green, and blue values.",
        not (0 <= r <= 255) or not (0 <= g <= 255) or not (0 <= b <= 255): "Please enter red, green, and blue values between 0 and 255."
    }
